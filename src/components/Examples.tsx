...
const Examples = () => {
  ...
  return (
    <section id="examples" ref={sectionRef} className="py-24 relative overflow-hidden scroll-trigger bg-gradient-to-br from-secondary to-background">
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[10%] right-[20%] w-72 h-72 bg-primary/10 rounded-full blur-3xl" />
        <div className="absolute bottom-[30%] left-[10%] w-96 h-96 bg-primary/10 rounded-full blur-3xl" />
      </div>
      
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">Sample Book Excerpts</h2>
        ...
        <div className="relative max-w-4xl mx-auto">
          <Button
            variant="outline"
            size="icon"
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 rounded-full bg-primary/10 shadow-md border-primary/20 hover:bg-primary/20 md:-left-6"
            onClick={handlePrev}
          >
            ...
            >
              {examples.map((example, index) => (
                <div key={index} className="min-w-full">
                  <div className="bg-primary/5 backdrop-blur-sm rounded-xl border border-primary/10 shadow-lg p-8 md:p-10">
                    <div className="flex flex-col md:flex-row gap-8">
                      <div className="md:w-1/3">
                        <div className="aspect-[2/3] bg-gradient-to-br from-primary/20 to-accent/10 rounded-lg flex items-center justify-center p-6 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-sm mb-4 text-foreground">{example.category}</p>
                          
                          <p className="text-sm font-medium text-primary mb-1">Description</p>
                          <p className="text-sm text-foreground">{example.description}</p>
                        </div>
                      </div>
                      ...
                      <div className="md:w-2/3">
                        ...
                        <div className="bg-primary/10 p-6 rounded-lg border border-primary/20">
                          <p className="text-lg leading-relaxed text-foreground">{example.excerpt}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 rounded-full bg-primary/10 shadow-md border-primary/20 hover:bg-primary/20 md:-right-6"
            onClick={handleNext}
          >
